    ...
    return (
        <div className="min-h-screen bg-[#f4f7fa] font-sans flex">
            ...
            <div className="flex-1 ml-[280px] flex flex-col min-h-screen">
                {/* Header */}
                <header className="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between shadow-sm shrink-0 sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-5 border-l border-gray-100 pl-6">
                        <button className="p-2 text-gray-400 hover:bg-gray-100 rounded-full border border-gray-200 shadow-sm bg-gray-50 relative">
                            <Bell size={18} />
                        </button>
                        <button className="p-2 text-gray-400 hover:bg-gray-100 rounded-full border border-gray-200 shadow-sm bg-gray-50">
                            <Settings size={18} />
                        </button>
                        <div className="flex items-center gap-3 cursor-pointer ml-2">
                            <div className="text-right hidden sm:block">
                                <h4 className="font-bold text-gray-900 text-sm leading-tight">Dr. Sarah Wilson</h4>
                                <p className="text-[11px] text-gray-500 font-medium">Chief Medical Officer</p>
                            </div>
                            <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-200 bg-teal-50">
                                <img src="https://api.dicebear.com/7.x/notionists/svg?seed=Sarah&backgroundColor=ccfbf1" alt="Dr" className="w-full h-full object-cover" />
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <main className="flex-1 w-full max-w-[1200px] mx-auto p-8 flex flex-col gap-6">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-4xl font-extrabold text-[#0f172a] tracking-tight mb-2">Patient Directory</h1>
                            <p className="text-gray-500 font-medium text-[15px]">Central database for managing medical records and patient status</p>
                        </div>
                        <button className="bg-[#0a2540] hover:bg-[#061626] text-white px-5 py-3.5 rounded-xl font-semibold flex items-center gap-2 shadow-sm transition-colors text-[15px]">
                    ...
                    <form onSubmit={handleSearch} className="flex items-center gap-4 mt-2">
                        ...
                        <button className="bg-[#e4efff] text-blue-700 px-5 py-3.5 rounded-xl font-bold flex items-center gap-2 text-sm shadow-sm hover:bg-blue-100 transition-colors">
                                            ...
                                            <tr key={p._id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                                ...
                                                <td className="py-5 px-6 text-right">
                                                    <div className="flex justify-end gap-3 text-gray-400">
                                                        ...
                                                        <button className="hover:text-amber-600 transition-colors"><Edit2 size={18} /></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        );
