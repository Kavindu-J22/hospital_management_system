...
const AdminPharmacyMap = () => {
    const navigate = useNavigate();
    // Center roughly around Sri Pura / Padavi Sripura
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fc] font-sans flex">
            ...
            {/* Main Content Area */}
            <div className="flex-1 ml-[280px] flex flex-col h-screen overflow-hidden bg-white">

                {/* Header */}
                <header className="h-[70px] border-b border-gray-200 flex items-center justify-between px-6 shrink-0 bg-white z-20">
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 text-xl font-bold text-[#0f172a]">
                    ...
                    <div className="flex items-center gap-5">
                        <button className="p-2 text-gray-400 hover:bg-gray-100 rounded-full transition-colors relative border border-gray-200 shadow-sm">
                            <Bell size={18} />
                        </button>
                        <div className="w-9 h-9 bg-teal-100 rounded-full overflow-hidden border border-teal-200 ml-2 shadow-sm cursor-pointer">
                ...
                <div className="flex flex-1 overflow-hidden relative">
                    ...
                    <aside className="w-[380px] bg-white border-r border-gray-200 flex flex-col h-full shrink-0 z-10 shadow-[4px_0_15px_rgba(0,0,0,0.02)]">
                        <div className="p-5 border-b border-gray-100">
                            <div className="flex items-center justify-between mb-2">
                                <h2 className="text-[20px] font-bold text-[#0f172a]">Hospital Pharmacies</h2>
                                <button className="text-blue-600 text-sm font-semibold hover:underline">Filters</button>
                            </div>
                            <p className="text-gray-500 text-sm flex items-center gap-1.5">
                                <MapPin size={14} /> Near Subdivisions
                            </p>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto pb-6">
                            {pharmacies.map((pharm) => (
                                <div
                                    key={pharm.id}
                                    className={`p-5 relative border-b border-gray-50 cursor-pointer ${pharm.selected ? 'border-l-4 border-l-blue-600 bg-blue-50/10' : 'hover:bg-gray-50 border-l-4 border-l-transparent transition-colors'}`}
                                >
                    ...
                    <div className="flex-1 bg-[#e5e5f7] relative">
                        ...
                        <div className="absolute top-[30%] left-[30%] z-10 bg-blue-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg pointer-events-none transform -translate-x-1/2 -translate-y-[45px]">
                        ...
                        {/* Redo search button */}
                        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-4 flex items-center gap-6">
...
export default AdminPharmacyMap;
