...
const seedAdmins = async () => {
  // Create admins one by one using save() to trigger pre-save hooks for password hashing
  const admin1 = await Admin.create({ fullName: 'Dr. Admin User', email: 'admin@behealthy.com', eid: 'EID-0001', password: 'admin123', role: 'admin', title: 'Hospital Administrator' });
  const admin2 = await Admin.create({ fullName: 'Sarah Staff', email: 'staff@behealthy.com', eid: 'EID-0002', password: 'staff123', role: 'staff', title: 'Front Desk Staff' });
  const created = [admin1, admin2];
  console.log(`✅ Seeded ${created.length} admin accounts`);
  return created;
};

const seedDoctors = async () => {
  // Create doctors one by one using create() to properly trigger pre-save hooks
  const doctorsData = [
    { fullName: 'Dr. Sarah Jenkins', email: 'sarah.jenkins@behealthy.com', nic: '880120-1234567', specialization: 'Cardiology', contactNumber: '+94 71 234 5678', yearsOfExperience: 12, licenseNumber: 'LIC-0001', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Senior Cardiologist with 12 years of experience.' },
    { fullName: 'Dr. Emily Rodriguez', email: 'emily.rodriguez@behealthy.com', nic: '890210-2345678', specialization: 'Pediatrics', contactNumber: '+94 72 345 6789', yearsOfExperience: 8, licenseNumber: 'LIC-0002', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Pediatric specialist focused on child wellness.' },
    { fullName: 'Dr. Marcus Thorne', email: 'marcus.thorne@behealthy.com', nic: '870315-3456789', specialization: 'Neurology', contactNumber: '+94 73 456 7890', yearsOfExperience: 15, licenseNumber: 'LIC-0003', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Expert neurologist specializing in brain disorders.' },
    { fullName: 'Dr. James Wilson', email: 'james.wilson@behealthy.com', nic: '860420-4567890', specialization: 'Orthopedics', contactNumber: '+94 74 567 8901', yearsOfExperience: 10, licenseNumber: 'LIC-0004', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Orthopedic surgeon with expertise in joint replacement.' },
    { fullName: 'Dr. Lisa Chen', email: 'lisa.chen@behealthy.com', nic: '910525-5678901', specialization: 'Endocrinology', contactNumber: '+94 75 678 9012', yearsOfExperience: 7, licenseNumber: 'LIC-0005', status: 'Approved', availability: 'Unavailable', password: 'doctor123', bio: 'Endocrinology and diabetes management specialist.' },
    { fullName: 'Dr. Alan Smith', email: 'alan.smith@behealthy.com', nic: '850630-6789012', specialization: 'Cardiology', contactNumber: '+94 76 789 0123', yearsOfExperience: 18, licenseNumber: 'LIC-0006', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Veteran cardiologist with 18 years of practice.' },
    { fullName: 'Dr. Elena Rodriguez', email: 'elena.rodriguez@behealthy.com', nic: '920735-7890123', specialization: 'Dermatology', contactNumber: '+94 77 890 1234', yearsOfExperience: 5, licenseNumber: 'LIC-0007', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Dermatology specialist for skin and hair conditions.' },
    { fullName: 'Dr. Michael Chen', email: 'michael.chen@behealthy.com', nic: '900840-8901234', specialization: 'General Medicine', contactNumber: '+94 78 901 2345', yearsOfExperience: 9, licenseNumber: 'LIC-0008', status: 'Pending', availability: 'Unavailable', password: 'doctor123', bio: 'General practitioner awaiting approval.' },
    { fullName: 'Dr. Mark Ruffalo', email: 'mark.ruffalo@behealthy.com', nic: '940945-9012345', specialization: 'Radiology', contactNumber: '+94 79 012 3456', yearsOfExperience: 6, licenseNumber: 'LIC-0009', status: 'Pending', availability: 'Unavailable', password: 'doctor123', bio: 'Radiologist with experience in diagnostic imaging.' },
    { fullName: 'Dr. Emily Chen', email: 'emily.chen@behealthy.com', nic: '881050-0123456', specialization: 'Cardiology', contactNumber: '+94 70 123 4567', yearsOfExperience: 11, licenseNumber: 'LIC-0010', status: 'Approved', availability: 'Available', password: 'doctor123', bio: 'Cardiology expert with focus on preventive care.' },
  ];
  
  // Create each doctor individually to ensure pre-save hooks are triggered
  const created = [];
...
const seedPatients = async () => {
  // Create patients one by one using create() to properly trigger pre-save hooks
  const patientsData = [
    { fullName: 'Alice Johnson', email: 'alice@example.com', nic: '901125-1111111', password: 'patient123', dateOfBirth: new Date('1990-05-14'), gender: 'female', contactNumber: '+94 71 111 2222', address: '12 Galle Road, Colombo', bloodGroup: 'A+', status: 'Stable', lastVisit: new Date('2026-04-10') },
    { fullName: 'Bob Smith', email: 'bob@example.com', nic: '720228-2222222', password: 'patient123', dateOfBirth: new Date('1972-03-15'), gender: 'male', contactNumber: '+94 72 222 3333', address: '45 Kandy Road, Peradeniya', bloodGroup: 'O+', status: 'Critical', lastVisit: new Date('2026-04-18') },
    { fullName: 'Charlie Davis', email: 'charlie@example.com', nic: '980330-3333333', password: 'patient123', dateOfBirth: new Date('1998-07-22'), gender: 'male', contactNumber: '+94 73 333 4444', address: '78 Temple Road, Nugegoda', bloodGroup: 'B-', status: 'Recovering', lastVisit: new Date('2026-04-15') },
    { fullName: 'John Doe', email: 'john.doe@example.com', nic: '850404-4444444', password: 'patient123', dateOfBirth: new Date('1985-09-10'), gender: 'male', contactNumber: '+94 74 444 5555', address: '23 Marine Drive, Colombo', bloodGroup: 'AB+', status: 'Stable', lastVisit: new Date('2026-04-12') },
    { fullName: 'Amara Silva', email: 'amara@example.com', nic: '950505-5555555', password: 'patient123', dateOfBirth: new Date('1995-11-05'), gender: 'female', contactNumber: '+94 75 555 6666', address: '56 Hill Street, Kandy', bloodGroup: 'A-', status: 'Active', lastVisit: new Date('2026-04-16') },
    { fullName: 'Alex Johnson', email: 'alex.j@example.com', nic: '881215-6666666', password: 'patient123', dateOfBirth: new Date('1988-12-20'), gender: 'male', contactNumber: '+94 76 666 7777', address: '90 Park Avenue, Colombo', bloodGroup: 'O-', status: 'Stable', lastVisit: new Date('2026-04-19') },
    { fullName: 'Sarah Thompson', email: 'sarah.t@example.com', nic: '920606-7777777', password: 'patient123', dateOfBirth: new Date('1992-06-18'), gender: 'female', contactNumber: '+94 77 777 8888', address: '34 Lake Road, Colombo', bloodGroup: 'B+', status: 'Stable', lastVisit: new Date('2026-04-17') },
    { fullName: 'Robert Wilson', email: 'robert.w@example.com', nic: '780707-8888888', password: 'patient123', dateOfBirth: new Date('1978-08-30'), gender: 'male', contactNumber: '+94 78 888 9999', address: '67 Main Street, Galle', bloodGroup: 'A+', status: 'Stable', lastVisit: new Date('2026-04-14') },
  ];
  
  // Create each patient individually to ensure pre-save hooks are triggered  
  const created = [];
